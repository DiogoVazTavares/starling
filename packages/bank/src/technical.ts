...
/**
 * Technical trees from wayfinder ticket 025 (Altium / frontend spoken screen set).
 * Absorbed from wayfinder/assets/025-technical-trees.ts.
 */
export const TECHNICAL_TREES: QuestionTree[] = [
  {
