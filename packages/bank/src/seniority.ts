...
/**
 * Seniority trees from wayfinder ticket 026 (seeds from 016 / interviewer SEED_BANK).
 * Absorbed from wayfinder/assets/026-seniority-trees.ts.
 */
export const SENIORITY_TREES: QuestionTree[] = [
  {
